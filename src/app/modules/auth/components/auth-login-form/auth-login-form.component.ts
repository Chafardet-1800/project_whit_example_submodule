...
import { chinchinShapeLogo } from 'src/app/common/assets/images/images-routes';
...
import { authExpirationTime, userLoggedVariable } from 'src/app/common/data/constants/local-storage-variables';
