...
import { CmmComponentTableModel, CmmTableColumnErrorMsg, CmmTableHeader, CmmTableRow, CmmStatusTypeGroupsModel } from 'commun/src/app/data/tables/models/tables.model';
